                            ...
                            <a href="">SIÊU SALE T9
                                <ul class="sub-menu">
                                    <div class="list-submenu">
                                        <div class="item-list-submenu">
                                            <h3>
                                                <a href="" style="color: #ff0000; font-size: 16px">SALE upto 50%</a>
                                            </h3>
                                            <ul>
                                                <li>
                                                    <a href="">Áo</a>
                ...
                <div class="list-images">
                    <div class="mySlides">
                        <a href="./lookbook/info.php">
                            <img src="./assets/img/banner-3.webp" alt="Slide 1" class="thumb" />
                        </a>
                    </div>
                    <div class="mySlides">
                        <img src="./assets/img/banner-1.webp" alt="Slide 2" class="thumb" />
                    </div>
                    <div class="mySlides">
                        <img src="./assets/img/banner-5.webp" alt="Slide 3" class="thumb" />
                    </div>
                    <div class="mySlides">
                        <img src="./assets/img/banner-4.webp" alt="Slide 4" class="thumb" />
                    </div>
                </div>
                <div class="btns">
